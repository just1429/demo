...
public class SearchService {
    ...
    public PageResult<Goods> search(SearchRequest request) {
        ...
        // 封装结果并返回
        //return new SearchResult<Goods>(total, new Long((long) totalPage), goodsPage.getContent());
        return new SearchResult(goodsPage.getContent(), total,  new Long((long) totalPage), categories, brands, specs);
    }
